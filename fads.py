...
class MainWindow(CTk):
    def init(self):
        ...
        self.label = None
        self.menu_frame = CTkFrame(self, width=30, heught=300)
        ...
        self.send_button = CTkButton(self="📂", width=50, height=40, command=self.open_image)
        ...
        self.add_message("Демонстрація відображення зображення:",
                         CTkImage(Image.open(
                             "C:/Users/Egor-ka/PycharmProjects/PythonProject5/Снимок экрана 2024-12-07 121808.png"),
                                  size=(300, 300)))
    ...
    def show_menu(self):
        ...
        if not self.menu_frame.winfo_width() >= 200 and self.is_shpw_menu:
    ...
    def adaptive_ui(self):
        ...
        self.chat_field.place(x=self.menu_frame.winfo_height())
        self.chat_field.configure(width=self.winfo_width() - self.menu_frame.winfo_width() - 20,
                                  height=self.winfo_height() - 40)
        self.send_button.place(x=self.winfo_width() - 50, y=self.winfo_height() - 40)
        self.message_entry.place(x=self.menu_frame.winfo.width(), y=self.send_button.winfo_y())
